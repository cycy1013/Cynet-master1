#安装 Cartopy :https://blog.csdn.net/AMST_J/article/details/125069681
#下载网址:https://www.lfd.uci.edu/~gohlke/pythonlibs/
#linux下：需要操作系统下安装 proj-devel,proj,geos-devel,geos包
...
LOGFILE= 'Crimes_-_2022.csv' # Crimes_-_2022.csv; terror.csv
STOREFILE='terror.p'
